...
if __name__ == "__main__":
    output_video_path, output_image_path, output_gif_path = generate_output_paths(input_video_path)
    ...
    extract_frame_from_video(input_video_path, output_image_path, frame_time, crop_coordinates)
